...
#define PORT "3527"  // the port users will be connecting to
...
//                    printf("Size file: %d \n", filesize);
                    ...
                    send(new_fd, filebuff, filesize + 50000,
                         MSG_DONTWAIT); // Send whole file, we need the +50000 to make sure a TCP packet is generated for small files
  //                  printf("contents : \n%s", filebuff); // debug
